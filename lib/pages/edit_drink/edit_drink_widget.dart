                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: FlutterFlowCountController(
                          ...
                          count: _model.drinkCountValue ??=
                              widget.drinkTotals!.count,
              ...
              children: [
                FFButtonWidget(
                  onPressed: () async {
                    ...
                    _model.existingTotalsDoc = await queryDrinkTotalsRecordOnce(
                      queryBuilder: (drinkTotalsRecord) => drinkTotalsRecord
                          ...
                          .where(
                            'drinkKey',
                            isEqualTo: functions.toLowerCase(
                                _model.drinkNameTextController.text),
                          ),
                      singleRecord: true,
                    ).then((s) => s.firstOrNull);
                    if (((_model.existingTotalsDoc != null) == false) ||
                        (_model.existingTotalsDoc?.reference ==
                            widget.drinkTotals?.reference)) {
                      await widget.drinkTotals!.reference
                          .update(createDrinkTotalsRecordData(
                        count: _model.drinkCountValue,
                        drinkKey: functions
                            .toLowerCase(_model.drinkNameTextController.text),
                        name: _model.drinkNameTextController.text,
                        sizeMl: functions.convertToMl(
                            double.parse(_model.drinkSizeTextController.text),
                      ...
                      await showDialog(
                        ...
                        builder: (alertDialogContext) {
                          return AlertDialog(
                            title: Text('Drink with that name already exists'),
                            actions: [
                              TextButton(
                                onPressed: () =>
